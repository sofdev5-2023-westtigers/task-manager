...
<div class="navbar bg-[#ABC4AA] h-32" >
    <div class="flex-1 px-2 lg:flex-none" >
        <img src="../src/resources/west.png"  class="w-21 h-16"/>
        <a class="text-4xl text-[#675D50] font-bold"> West Tigers</a>
    </div> 
    <div class="flex justify-end flex-1 px-2">
        <div class="flex items-stretch">
            <a on:click={logout} class="text-xl text-[#675D50] btn btn-ghost rounded-btn">Logout</a>
        </div>
    </div>
</div>
    ...
    <div class="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
            ...
            <p class="py-6 text-2xl text-[#675D50]">On this platform, you will be able to effectively keep track of your daily tasks in a simple and intuitive way. 
                ...
                <a href="/todo-lists" class="btn bg-[#ABC4AA] border-none text-[#675D50]">See Lists</a>
        </div>
    </div>
</div>