...
<div style="" class="mt-2 card-task">
	...
	<div class="name-label">
		...
		<ModalAddMembers
				htmlMenssage = {"in the task manager app you were added to the Task " + inputValue + " in List " + nameList}
				textMenssage = {"Add new Task"}
				subjectMenssage = {"Added to a Task!!"}
				titleModal = {"Task"}
				bind:modalAddMembers = {modalAddMembersTask}
			/>
		<button
