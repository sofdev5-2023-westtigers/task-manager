...
<div class="listTasks" style="padding-top:80px;">
	<div class="w-full sm:w-3/5">
		<div
			id="addNewList"
			class="addNewList mt-2 mb-4 sm:mb-0 flex items-center justify-center sm:justify-start"
			style="padding-left: 100px; padding-right: 100px"
		>
			<input
				class="text-nameList border-gray-300 bg-gray-100 rounded-[20PX] w-full sm:w-auto px-4 py-2 mr-2 sm:mr-4"
				type="text"
				name="name"
			...
			<button
				...
				type="button"
				on:click={createList}>Add List</button
			>
			{#if showAlert && nameError !== ''}
				<div
					class="alert mt-2 text-red-500 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
				>
