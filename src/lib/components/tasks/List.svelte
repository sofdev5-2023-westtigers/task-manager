		...
		<div class="container-list max-w-xl p-4 mb-4">
			...
			<div style="display: inline-flex; justify-content: center;">
				...
				<Modal  bind:open={walletModal} size="xs" padding="xs">
					<h2>Member of List
						<Button pill={true} outline={true} color="green" class="!p-2" size="xl"  on:click={() => modalAddMembersList = true}>
						...
						<Modal bind:open={modalAddMembersList} size="xs" autoclose={false} class="w-full">
							<form class="flex flex-col space-y-6" action="#">
							  ...
							  <Button type="submit" color="green" class="w-full1" on:click={() => submitForm()}>Add Member to List</Button>
							</form>
						  </Modal>
					</h2>
					<p class="text-sm font-normal text-gray-500 dark:text-gray-400">This is the list of all members added to this list</p>
					<ul class="my-4 space-y-3">
					  <li>
						<a class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
							...
							<span class="flex-1 ml-3 whitespace-nowrap">PEPITO PEREZ</span>
							<Button pill={true} outline={true} color="dark" class="!p-2" size="xs">
								<svg aria-hidden="true" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
								  <path fill-rule="evenodd" d="M2 10h16" stroke="currentColor" stroke-width="2"></path>
								</svg>
							  </Button>
